				...
				<div class="main-inner group">
						...
						<?php /* if (isset($is_front)):?>
							<div id="profile" class="pad group">
								<div id="profile-inner">
									...
									<div id="profile-image"><img src="<?php echo get_author('octt')[0]->avatar;?>" alt="<?php echo blog_title();?>"></div>
					...
					<div class="sidebar s1">
						...
						<div class="sidebar-content">
							...
							<div id="pages-menu" class="widget widget_pages">
							<h3 class="group"><span><?php echo i18n("Pages");?></span></h3>
		...
		<div id="footer-bottom">
			...
			<div class="pad group">
				<div class="grid one-full">
					...
					<div id="credit"><span>Design by <a href="http://alx.media/" rel="nofollow" target="_blank">Alx</a> and me.</span></div><!--/#credit-->
...
<div style="
	/* https://art.pixilart.com/c55bdcb2d054a81.png */
	background-image: url('https://stuff.octt.eu.org/content/images/20250609154347-c55bdcb2d054a81.png');
	height: 64px;
	width: 100%;
...
<script type="text/javascript">
	...
	var container = document.querySelector('div.entry-content');
	if (container) {
		var link = location.href.split('#')[0];
		var qrcode = Object.assign(document.createElement('a'), { id: "page-qr-code", href: link });
		container.insertAdjacentElement('afterend', qrcode);
